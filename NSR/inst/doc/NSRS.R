...
#  
#  library(devtools)
#  install_github("EnquistLab/RNSRS/NSRS")
#  
#  

## ------------------------------------------------------------------------
library(NSRS)
NSRS_super_simple(species = "Acer rubrum",
                 country =  "Canada", 
...
#The NSRS function expects 7 columns as input, however only the fields "species" and "country" need to be populated.
#If you ever forget, you can use the function NSRS_template as a quick lookup, or to populate.

pima_query<-NSRS_template(nrow = nrow(pima))
...
pima_nsrs_results <- NSRS(pima_query)

head(pima_nsrs_results)
